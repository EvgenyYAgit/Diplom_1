...
class TestBurger:
    ...
    def test_set_buns(self, name_of_bun):
        some_burger = Burger()
    ...
    def test_remove_ingredient(self, ingredient_one, ingredient_two):
        some_burger = Burger()
    ...
    @pytest.mark.parametrize('ingredient_one, ingredient_two ',
                             [["лунный огурец", "адаманитовый помидор"], ["марсовый перец", "юпитерский сыр"]])
    def test_move_ingredient(self, ingredient_one, ingredient_two):
        some_burger = Burger()
        some_burger.add_ingredient(ingredient_one)
        some_burger.add_ingredient(ingredient_two)
